...
contract LendingPool is ReentrancyGuard {
   ...
   /************* Lender functions ************************/
    ...
    function oneTokenEqualToHowManyUSD(address _tokenAddress) public view returns(uint)  {
        ...
        if(_tokenAddress == 0x583031D1113aD414F02576BD6afaBfb302140225 ) {
            return 1467;
        }
        if(_tokenAddress == 0x0fC5025C764cE34df352757e82f7B5c4Df39A836) {
            // DAI
            return 1;    
        } 

        if(_tokenAddress == 0xf8e81D47203A594245E36C48e151709F0C19fBe8) {
            // LINK
            return 6;
        }
        if(_tokenAddress == 0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B) {
            // USDC 
            return 1;
        }
